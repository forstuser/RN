...
export default {
  ...
  expense_forms_amc_form_amc_amount: "AMC Amount (in ₹)",
  ...
  expense_forms_expense_basic_expense_amount: "Amount (in ₹)",
  ...
  expense_forms_insurance_premium_amount: "Insurance Premium Amount (in ₹)",
  expense_forms_insurance_upload_policy: "Upload Policy Doc",
  expense_forms_insurance_total_coverage: "Total Coverage (in ₹)",
  ...
  expense_forms_product_basics_purchase_amount: "Purchase Amount (in ₹)",
  ...
  expense_forms_puc_amount: "PUC Amount (in ₹)",
  ...
  expense_forms_repair_amount: "Repair Amount (in ₹)",
  ...
  expense_forms_warranty_amount: "Amount (in ₹)",
