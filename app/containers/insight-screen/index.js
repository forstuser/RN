    ...
    return (
      <ScrollView style={styles.container}>
        <View style={styles.filterHeader}>
          ...
          <TouchableOpacity
            onPress={() => this.insightModal.show()}
            style={styles.filter}
          >
        ...
        <ExpensesChart colors={legendColors} chartData={this.state.chartData} />
        ...
        <View>
          {categories.map((category, index) => (
            <TouchableOpacity key={category.cName} style={styles.item}>
              <View
                style={[
                  styles.itemColorDot,
